...
typedef struct xCOMMAND_LINE_INPUT {
	...
	/* String that describes how to use the command.  Should start with the
	 * command itself, and end with "\r\n".  For example "help: Returns a list
	 * of all the commands\r\n". */
	const char * const pcHelpString;
	/* A pointer to the callback function that will return the output generated
	 * by the command. */
...
/*
 * Return a pointer to the list of registered commands.
 */
