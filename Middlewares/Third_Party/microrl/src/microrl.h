...
#define _VT100_HOME_CODE			'1'
#define _VT100_END_CODE				'4'
#define _VT100_BRACKET_CODE			'['
#define _VT100_TILDA_CODE			'~'
#define _VT100_CURSOR_UP_CODE		'A'
#define _VT100_CURSOR_DOWN_CODE		'B'
#define _VT100_CURSOR_RIGHT_CODE	'C'
#define _VT100_CURSOR_LEFT_CODE		'D'
...
//	int (*execute) (int argc, const char * const * argv);            // ptr to 'execute' callback
	int (*execute) (const char * const arg);
